...
object SupportedLanguages {
    ...
    internal val all: Map<String, SupportedLanguage> by lazy {
        mapOf(
            ...
            "arduino" to Arduino,
            "ino" to Ino,
            "armasm" to ARMAssembler,
            "arm" to Arm,
            "avrasm" to AVRAssembler,
            ...
            "hbs" to Hbs,
            "html.hbs" to HtmlHbs,
            "html.handlebars" to HtmlHandlebars,
            "haskell" to Haskell,
            "hs" to Hs,
            "haxe" to Haxe,
            "hx" to Hx,
            ...
            "lasso" to Lasso,
            "ls" to Lasso_LS,
            "lassoscript" to LassoScript,
            "less" to Less,
            "ldif" to LDIF,
            "lisp" to Lisp,
            "livecodeserver" to LiveCodeServer,
            ...
            "matlab" to Matlab,
            "maxima" to Maxima,
            "mel" to MayaEmbeddedLanguage,
            "mercury" to Mercury,
            "mipsasm" to MIPSAssembler,
            "mips" to Mips,
            "mizar" to Mizar,
            ...
            "obj-c" to Obj_C,
            "obj-c++" to ObjCpp,
            "objective-c++" to ObjectiveCpp,
            "glsl" to OpenGLShadingLanguage,
            "openscad" to OpenSCAD,
            "scad" to Scad,
            "ruleslanguage" to OracleRulesLanguage,
            "oxygene" to Oxygene,
            "pf" to PF,
            "pf.conf" to PfConf,
            "php" to PHP,
            ...
            "py" to Py,
            "gyp" to Gyp,
            "profile" to PythonProfilerResults,
            "python-repl" to PythonREPL,
            "pycon" to Pycon,
            "k" to Q,
            "qml" to QML,
            "r" to R,
            ...
            "tcl" to Tcl,
            "tk" to Tk,
            "tap" to TestAnythingProtocol,
            "thrift" to Thrift,
            "tp" to TP,
            "twig" to Twig,
            "craftcms" to CraftCMS,
