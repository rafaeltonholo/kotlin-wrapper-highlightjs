...
object SupportedLanguages {
    ...
    internal val all: Map<String, SupportedLanguage> by lazy {
        mapOf(
            "1c" to OneC,
            "abnf" to ABNF,
            "accesslog" to AccessLogs,
            "ada" to Ada,
            "armasm" to Arduino,
            "arm" to Ino,
            "avrasm" to ARMAssembler,
            "actionscript" to Arm,
            "as" to AVRAssembler,
            "angelscript" to ActionScript,
            "asc" to As,
            "apache" to AngelScript,
            "apacheconf" to Asc,
            "applescript" to Apache,
            "osascript" to ApacheConf,
            "arcade" to AppleScript,
            "asciidoc" to Osascript,
            "adoc" to Arcade,
            "aspectj" to AsciiDoc,
            "autohotkey" to ADoc,
            "autoit" to AspectJ,
            ...
            "capnproto" to CSP,
            "capnp" to CSS,
            "clojure" to CapNProto,
            "clj" to Capnp,
            "coffeescript" to Clojure,
            "coffee" to Clj,
            ...
            "html.handlebars" to Hbs,
            "haskell" to HtmlHbs,
            "hs" to HtmlHandlebars,
            "haxe" to Haskell,
            "hx" to Hs,
            "hy" to Haxe,
            "hylang" to Hx,
            ...
            "livescript" to LDIF,
            "ls" to Lisp,
            "lua" to LiveCodeServer,
            "makefile" to LiveScript,
            "mk" to Ls,
            "mak" to Lua,
            "make" to Makefile,
            "markdown" to Mk,
            ...
            "mercury" to Matlab,
            "mipsasm" to Maxima,
            "mips" to MayaEmbeddedLanguage,
            "mizar" to Mercury,
            "mojolicious" to MIPSAssembler,
            "monkey" to Mips,
            "moonscript" to Mizar,
            "moon" to Mojolicious,
            "n1ql" to Monkey,
            ...
            "glsl" to Obj_C,
            "openscad" to ObjCpp,
            "scad" to ObjectiveCpp,
            "oxygene" to OpenGLShadingLanguage,
            "pf" to OpenSCAD,
            "pf.conf" to Scad,
            "php" to OracleRulesLanguage,
            "parser3" to Oxygene,
            "perl" to PF,
            "pl" to PfConf,
            "pm" to PHP,
            "plaintext" to Parser3,
            "txt" to Perl,
            "text" to Pl,
            "pony" to Pm,
            "pgsql" to Plaintext,
            ...
            "ps" to PostgresSQL,
            "ps1" to Postgres,
            "processing" to Postgresql,
            "prolog" to PowerShell,
            "properties" to Ps,
            "protobuf" to Ps1,
            "proto" to Processing,
            "puppet" to Prolog,
            "pp" to Properties,
            "python" to ProtocolBuffers,
            "py" to Protobuf,
            "gyp" to Puppet,
            "profile" to Pp,
            "python-repl" to Python,
            "pycon" to Py,
            "k" to Gyp,
            "k" to PythonProfilerResults,
            "kdb" to PythonREPL,
            "qml" to Pycon,
            "r" to Q,
            "reasonml" to K,
            ...
            "graph" to ReasonML,
            "instances" to Re,
            "ruby" to RenderManRIB,
            "rb" to RenderManRSL,
            "gemspec" to Roboconf,
            "podspec" to Instances,
            "thor" to Ruby,
            "irb" to Rb,
            "rust" to Gemspec,
            "rs" to Podspec,
            ...
            "tp" to Tcl,
            "twig" to Tk,
            "craftcms" to TestAnythingProtocol,
            "typescript" to Thrift,
            "ts" to TP,
            "tsx" to Twig,
            "mts" to CraftCMS,
            "cts" to TypeScript,
...
fun String.toSupportedLanguage(): SupportedLanguage? {
    return SupportedLanguages.all[this]
}
